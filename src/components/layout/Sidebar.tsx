...
const navItems = [
  ...
  { to: "/records/new", label: "Expedientes", icon: IconExpediente },
  { to: "/reports", label: "Reportes", icon: IconReportes },
  { to: "/settings", label: "Configuración", icon: IconConfiguracion },
  { to: "/help", label: "Ayuda", icon: IconAyuda },
] as const;
...
function IconReportes({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function IconAyuda({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
